...
void Initialize_GPIO(void)
{
	...
	Pinmux_Config(BAT_VOLT_IN_CONT_PIN, GPIO_FUN);
	...
	Pad_Config(BAT_VOLT_IN_CONT_PIN , PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_NONE, PAD_OUT_ENABLE, PAD_OUT_HIGH);
	...
	/* GPIO Parameter Config */
	{
		...
		GPIO_InitStruct.GPIO_Pin  = GPIO_STATUS_LED_PIN|GPIO_S4_TEST_KEY_PIN|GPIO_PWR_CONTROL_PIN|GPIO_BAT_VOLT_IN_CONT_PIN;
